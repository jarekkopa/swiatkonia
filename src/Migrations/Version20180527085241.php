 ...
 */
final class Version20180527085241 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__advert AS SELECT id, adv_category_id, user_id, region_id_id, adv_title, adv_description, price, image_name, image_size, is_active FROM advert');
        ...
        $this->addSql('INSERT INTO advert (id, adv_category_id, user_id, region_id_id, adv_title, adv_description, price, image_name, image_size, is_active) SELECT id, adv_category_id, user_id, region_id_id, adv_title, adv_description, price, image_name, image_size, is_active FROM __temp__advert');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__advert AS SELECT id, adv_category_id, user_id, region_id_id, adv_title, adv_description, price, image_name, image_size, is_active FROM advert');
        $this->addSql('DROP TABLE advert');
        $this->addSql('CREATE TABLE advert (id INTEGER NOT NULL, adv_category_id INTEGER NOT NULL, user_id INTEGER NOT NULL, region_id_id INTEGER DEFAULT NULL, adv_title VARCHAR(255) NOT NULL, adv_description CLOB DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INTEGER DEFAULT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO advert (id, adv_category_id, user_id, region_id_id, adv_title, adv_description, price, image_name, image_size, is_active) SELECT id, adv_category_id, user_id, region_id_id, adv_title, adv_description, price, image_name, image_size, is_active FROM __temp__advert');
        $this->addSql('DROP TABLE __temp__advert');
        $this->addSql('CREATE INDEX IDX_54F1F40B9458D7F4 ON advert (adv_category_id)');
        $this->addSql('CREATE INDEX IDX_54F1F40BA76ED395 ON advert (user_id)');
