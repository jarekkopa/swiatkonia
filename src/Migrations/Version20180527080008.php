 ...
 */
final class Version20180527080008 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INTEGER NOT NULL, adv_category_id INTEGER NOT NULL, user_id INTEGER NOT NULL, region_id_id INTEGER DEFAULT NULL, adv_title VARCHAR(255) NOT NULL COLLATE BINARY, adv_description CLOB DEFAULT NULL COLLATE BINARY, price NUMERIC(10, 2) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_size INTEGER DEFAULT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_54F1F40B9458D7F4 FOREIGN KEY (adv_category_id) REFERENCES category_entity (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_54F1F40BA76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_54F1F40BC7209D4F FOREIGN KEY (region_id_id) REFERENCES region_entity (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
